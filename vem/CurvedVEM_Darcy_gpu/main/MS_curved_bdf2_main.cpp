...
int main(int argc, char**) {
    ...
    if (argc != 1) {
        std::cerr << "请在 main/MS_curved_bdf2_main.cpp 中修改参数。\n";
        return 1;
    }
    try {
        // ========== 算例、空间阶与积分规则 ==========
        ...
        const std::vector<int> meshes = {2, 4, 8, 16};
        ...
        study.title = "MS 算例 2：正弦曲边制造解 BDF2 空间收敛实验";
        ...
        std::cerr << "MS_curved_bdf2 运行失败：" << e.what() << '\n';
        return 1;
    }
}
